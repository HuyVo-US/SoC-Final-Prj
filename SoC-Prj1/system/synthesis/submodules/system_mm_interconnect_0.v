...
module system_mm_interconnect_0 (
	...
	wire   [9:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> hex0_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> switch_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> hex1_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // hex1_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [9:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> hex1_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> hex2_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // hex2_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [9:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> hex2_s1_agent:cp_channel
	...
	wire         cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> hex3_s1_agent:cp_valid
	wire  [94:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> hex3_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // hex3_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [9:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> hex3_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> hex3_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> hex3_s1_agent:cp_endofpacket
	...
	wire   [9:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> hex4_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> hex5_s1_agent:cp_channel
	...
	wire  [94:0] hex1_s1_agent_rp_data;                                                              // hex1_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [94:0] hex2_s1_agent_rp_data;                                                              // hex2_s1_agent:rp_data -> router_008:sink_data
	...
	wire         hex3_s1_agent_rp_valid;                                                             // hex3_s1_agent:rp_valid -> router_009:sink_valid
	wire  [94:0] hex3_s1_agent_rp_data;                                                              // hex3_s1_agent:rp_data -> router_009:sink_data
	wire         hex3_s1_agent_rp_ready;                                                             // router_009:sink_ready -> hex3_s1_agent:rp_ready
	wire         hex3_s1_agent_rp_startofpacket;                                                     // hex3_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         hex3_s1_agent_rp_endofpacket;                                                       // hex3_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         hex3_s1_agent_rdata_fifo_src_valid;                                                 // hex3_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] hex3_s1_agent_rdata_fifo_src_data;                                                  // hex3_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         hex3_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_007:in_0_ready -> hex3_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> hex3_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> hex3_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                  // hex3_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> hex3_s1_agent:rdata_fifo_sink_error
