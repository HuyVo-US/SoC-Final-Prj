...
module system_mm_interconnect_1 (
		...
		input  wire [12:0] dma_0_control_port_slave_readdata,       //                                  .readdata
		output wire [12:0] dma_0_control_port_slave_writedata,      //                                  .writedata
	...
	wire   [4:0] dma_0_read_master_translator_avalon_universal_master_0_address;        // dma_0_read_master_translator:uav_address -> dma_0_read_master_agent:av_address
	...
	wire  [56:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> dma_0_read_master_agent:rp_data
	...
	wire  [56:0] rsp_mux_001_src_data;                                                  // rsp_mux_001:src_data -> dma_0_write_master_agent:rp_data
	...
	wire   [4:0] dma_0_control_port_slave_agent_m0_address;                             // dma_0_control_port_slave_agent:m0_address -> dma_0_control_port_slave_translator:uav_address
	...
	wire  [75:0] dma_0_control_port_slave_agent_rf_source_data;                         // dma_0_control_port_slave_agent:rf_source_data -> dma_0_control_port_slave_agent_rsp_fifo:in_data
	...
	wire  [75:0] dma_0_control_port_slave_agent_rsp_fifo_out_data;                      // dma_0_control_port_slave_agent_rsp_fifo:out_data -> dma_0_control_port_slave_agent:rf_sink_data
	...
	wire  [56:0] dma_0_read_master_agent_cp_data;                                       // dma_0_read_master_agent:cp_data -> router:sink_data
	...
	wire  [56:0] dma_0_write_master_agent_cp_data;                                      // dma_0_write_master_agent:cp_data -> router_001:sink_data
	...
	wire  [56:0] router_001_src_data;                                                   // router_001:src_data -> cmd_demux_001:sink_data
	...
	wire  [74:0] dma_0_control_port_slave_agent_rp_data;                                // dma_0_control_port_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [56:0] cmd_demux_001_src0_data;                                               // cmd_demux_001:src0_data -> cmd_mux:sink1_data
	...
	wire  [56:0] rsp_demux_src1_data;                                                   // rsp_demux:src1_data -> rsp_mux_001:sink0_data
	...
	wire         cmd_mux_src_valid;                                                     // cmd_mux:src_valid -> dma_0_control_port_slave_cmd_width_adapter:in_valid
	wire  [56:0] cmd_mux_src_data;                                                      // cmd_mux:src_data -> dma_0_control_port_slave_cmd_width_adapter:in_data
	wire         cmd_mux_src_ready;                                                     // dma_0_control_port_slave_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                   // cmd_mux:src_channel -> dma_0_control_port_slave_cmd_width_adapter:in_channel
	wire         cmd_mux_src_startofpacket;                                             // cmd_mux:src_startofpacket -> dma_0_control_port_slave_cmd_width_adapter:in_startofpacket
	wire         cmd_mux_src_endofpacket;                                               // cmd_mux:src_endofpacket -> dma_0_control_port_slave_cmd_width_adapter:in_endofpacket
	wire         dma_0_control_port_slave_cmd_width_adapter_src_valid;                  // dma_0_control_port_slave_cmd_width_adapter:out_valid -> dma_0_control_port_slave_agent:cp_valid
	wire  [74:0] dma_0_control_port_slave_cmd_width_adapter_src_data;                   // dma_0_control_port_slave_cmd_width_adapter:out_data -> dma_0_control_port_slave_agent:cp_data
	wire         dma_0_control_port_slave_cmd_width_adapter_src_ready;                  // dma_0_control_port_slave_agent:cp_ready -> dma_0_control_port_slave_cmd_width_adapter:out_ready
	wire   [1:0] dma_0_control_port_slave_cmd_width_adapter_src_channel;                // dma_0_control_port_slave_cmd_width_adapter:out_channel -> dma_0_control_port_slave_agent:cp_channel
	wire         dma_0_control_port_slave_cmd_width_adapter_src_startofpacket;          // dma_0_control_port_slave_cmd_width_adapter:out_startofpacket -> dma_0_control_port_slave_agent:cp_startofpacket
	wire         dma_0_control_port_slave_cmd_width_adapter_src_endofpacket;            // dma_0_control_port_slave_cmd_width_adapter:out_endofpacket -> dma_0_control_port_slave_agent:cp_endofpacket
	wire         router_002_src_valid;                                                  // router_002:src_valid -> dma_0_control_port_slave_rsp_width_adapter:in_valid
	wire  [74:0] router_002_src_data;                                                   // router_002:src_data -> dma_0_control_port_slave_rsp_width_adapter:in_data
	wire         router_002_src_ready;                                                  // dma_0_control_port_slave_rsp_width_adapter:in_ready -> router_002:src_ready
	wire   [1:0] router_002_src_channel;                                                // router_002:src_channel -> dma_0_control_port_slave_rsp_width_adapter:in_channel
	wire         router_002_src_startofpacket;                                          // router_002:src_startofpacket -> dma_0_control_port_slave_rsp_width_adapter:in_startofpacket
	wire         router_002_src_endofpacket;                                            // router_002:src_endofpacket -> dma_0_control_port_slave_rsp_width_adapter:in_endofpacket
	wire         dma_0_control_port_slave_rsp_width_adapter_src_valid;                  // dma_0_control_port_slave_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [56:0] dma_0_control_port_slave_rsp_width_adapter_src_data;                   // dma_0_control_port_slave_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire         dma_0_control_port_slave_rsp_width_adapter_src_ready;                  // rsp_demux:sink_ready -> dma_0_control_port_slave_rsp_width_adapter:out_ready
	wire   [1:0] dma_0_control_port_slave_rsp_width_adapter_src_channel;                // dma_0_control_port_slave_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire         dma_0_control_port_slave_rsp_width_adapter_src_startofpacket;          // dma_0_control_port_slave_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire         dma_0_control_port_slave_rsp_width_adapter_src_endofpacket;            // dma_0_control_port_slave_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (dma_0_control_port_slave_cmd_width_adapter_src_ready),         //              cp.ready
		.cp_valid                (dma_0_control_port_slave_cmd_width_adapter_src_valid),         //                .valid
		.cp_data                 (dma_0_control_port_slave_cmd_width_adapter_src_data),          //                .data
		.cp_startofpacket        (dma_0_control_port_slave_cmd_width_adapter_src_startofpacket), //                .startofpacket
		.cp_endofpacket          (dma_0_control_port_slave_cmd_width_adapter_src_endofpacket),   //                .endofpacket
		.cp_channel              (dma_0_control_port_slave_cmd_width_adapter_src_channel),       //                .channel
	...
	system_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clock_clk_clk),                                                //       clk.clk
		.reset              (dma_0_reset_reset_bridge_in_reset_reset),                      // clk_reset.reset
		.sink_ready         (dma_0_control_port_slave_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (dma_0_control_port_slave_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (dma_0_control_port_slave_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (dma_0_control_port_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (dma_0_control_port_slave_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (dma_0_control_port_slave_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
	...
	) dma_0_control_port_slave_cmd_width_adapter (
		.clk                  (clock_clk_clk),                                                //       clk.clk
		.reset                (dma_0_reset_reset_bridge_in_reset_reset),                      // clk_reset.reset
		...
		.out_endofpacket      (dma_0_control_port_slave_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (dma_0_control_port_slave_cmd_width_adapter_src_data),          //          .data
		.out_channel          (dma_0_control_port_slave_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (dma_0_control_port_slave_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (dma_0_control_port_slave_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (dma_0_control_port_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) dma_0_control_port_slave_rsp_width_adapter (
		.clk                  (clock_clk_clk),                                                //       clk.clk
		.reset                (dma_0_reset_reset_bridge_in_reset_reset),                      // clk_reset.reset
		...
		.out_endofpacket      (dma_0_control_port_slave_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (dma_0_control_port_slave_rsp_width_adapter_src_data),          //          .data
		.out_channel          (dma_0_control_port_slave_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (dma_0_control_port_slave_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (dma_0_control_port_slave_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (dma_0_control_port_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                        // (terminated)
	);
